...
class ChipsInputState<T extends Object> extends State<ChipsInput<T>> with RestorationMixin {
  ...
  void initState() {
    ...
    final String chipSpaces = _chips.map((e) => space).join();
  ...
  Widget build(BuildContext context) {
    ...
    final maxReached =
        widget.maxChips != null && widget.maxChips! <= _chips.length && _chips.isNotEmpty;
    ...
    return RawAutocomplete<T>(
      ...
      fieldViewBuilder: (
        ...
        final List<Widget> chipsAndTextField = [
          ...chipwidgets,
          IntrinsicWidth(
            child: TextField(
